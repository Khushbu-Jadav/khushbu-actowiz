...
from bonkers_parser import parse_product_page
from db import execute_query
from queries import database_query, bonker_product_query, insert_product_query
import json
...
execute_query("bonker_db", query=bonker_product_query)

req = Request_Data(url=url,headers=DEFAULT_HEADERS,path=MAIN_PAGE_SAVE_DIR)
...
if response['is_success']:
    ...
    execute_query("bonker_db", query=insert_product_query, values=values)
